...
mod tag_filtering_tests {
    ...
    fn test_task_display_completeness() {
        ...
        assert!(
            ...
            "Should have task_type field"
        );
        assert!(
            task.get("description").is_some(),
        ...
        assert!(
            task.get("custom_fields").is_some(),
            "Should have custom_fields field"
        );
        ...
        assert!(
            custom_fields.contains_key("custom"),
